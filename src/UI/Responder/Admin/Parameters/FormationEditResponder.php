...
final class FormationEditResponder implements FormationEditResponderInterface
{
    /**
     * @var Environment
     */
    ...
    /**
     * FormationEditResponder constructor.
    ...
    public function response($redirect = false, FormInterface $form = null, Formation $formation): Response
    {
        $redirect ?
            ...
            $response = new Response($this->twig->render('admin/formation-edit.html.twig', [
